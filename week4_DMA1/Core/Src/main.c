...
/* USER CODE BEGIN PV */
// container of DMA (PA0 PA1 Temp Vref)
...
void TimeGame(){
	uint8_t clrnc = 5;
	if(Realtime - timestp >= randomTime - clrnc &&
			Realtime - timestp <= randomTime + clrnc){ //start time count
	...
	else{responTime = responTime;deb_stp = 4;}
